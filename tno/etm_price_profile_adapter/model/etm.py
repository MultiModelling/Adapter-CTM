...
# To my understanding, the store_result method called on line 38 will refer to model.py line 63 (store_result).
# This line will then run the process_result as defined in etm.py AND NOT in model.py. Is this correct?
